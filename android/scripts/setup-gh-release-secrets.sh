...
Environment variables:
  ...
  KEYSTORE_DNAME             DName for new key (default: CN=GokrazyManager, OU=CI, O=GokrazyManager, L=Unknown, ST=Unknown, C=US)
...
KEYSTORE_DNAME="${KEYSTORE_DNAME:-CN=GokrazyManager, OU=CI, O=GokrazyManager, L=Unknown, ST=Unknown, C=US}"
