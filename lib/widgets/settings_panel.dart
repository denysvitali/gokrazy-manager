    ...
    return GlassCard(
      ...
      child: Column(
        ...
        children: const [
          SectionHeader(
            title: 'Data & privacy',
            subtitle: 'Where your appliance details live',
          ...
          _DataRow(
            ...
            title: 'Instances',
            description:
                'Connection details are stored locally with shared_preferences.',
          ),
          ...
          _DataRow(
            ...
            title: 'Credentials',
            description:
                'Passwords sit in the platform secure keystore (Keychain, Keystore, etc.).',
          ),
          SizedBox(height: AppSpacing.s),
          _DataRow(
            ...
            title: 'Certificates',
            description:
                'Self-signed certificates are pinned per appliance after explicit approval.',
          ),
        ],
      ),
    );
